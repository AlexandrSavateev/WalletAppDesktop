...
class Main(tk.Frame):
 	...
 	def init_main(self):
 		...
 		self.add_img = tk.PhotoImage(file ='banknote.png')
 		...
 		self.tree.column('description', width=235, anchor =tk.CENTER)
 		self.tree.column('costs', width=235, anchor =tk.CENTER)
 		self.tree.column('total', width=235, anchor =tk.CENTER)
